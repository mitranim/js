...
Links: [source](../lang.mjs#L7); [test/example](../test/lang_test.mjs#L266).
...
Links: [source](../lang.mjs#L12); [test/example](../test/lang_test.mjs#L274).

Inverse of [#`isNil`](#function-isnil). False for `null` and `undefined`, true for other values.

### `function isBool`

Links: [source](../lang.mjs#L17); [test/example](../test/lang_test.mjs#L282).

Same as `typeof val === 'boolean'`.

### `function isNum`

Links: [source](../lang.mjs#L23); [test/example](../test/lang_test.mjs#L291).
...
Links: [source](../lang.mjs#L29); [test/example](../test/lang_test.mjs#L303).
...
Links: [source](../lang.mjs#L35); [test/example](../test/lang_test.mjs#L318).

True if the value is finite (via [#`isFin`](#function-isfin)) and < 0.

### `function isFinPos`

Links: [source](../lang.mjs#L40); [test/example](../test/lang_test.mjs#L338).

True if the value is finite (via [#`isFin`](#function-isfin)) and > 0.

### `function isInt`

Links: [source](../lang.mjs#L46); [test/example](../test/lang_test.mjs#L358).

True if the value is an integer: finite via [#`isFin`](#function-isfin), without a fractional part.

### `function isNat`

Links: [source](../lang.mjs#L52); [test/example](../test/lang_test.mjs#L377).

True if the value is a natural number: integer >= 0. Also see [#`isIntPos`](#function-isintpos).

### `function isIntNeg`

Links: [source](../lang.mjs#L58); [test/example](../test/lang_test.mjs#L396).

True if the value is integer < 0. Also see [#`isFinNeg`](#function-isfinneg).

### `function isIntPos`

Links: [source](../lang.mjs#L63); [test/example](../test/lang_test.mjs#L415).

True if the value is integer > 0. Also see [#`isNat`](#function-isnat), [#`isFinPos`](#function-isfinpos).

### `function isNaN`

Links: [source](../lang.mjs#L68); [test/example](../test/lang_test.mjs#L434).
...
Links: [source](../lang.mjs#L73); [test/example](../test/lang_test.mjs#L449).

True if the value is `-Infinity` or `Infinity`.

### `function isBigInt`

Links: [source](../lang.mjs#L78); [test/example](../test/lang_test.mjs#L464).
...
Links: [source](../lang.mjs#L84); [test/example](../test/lang_test.mjs#L483).

Same as `typeof val === 'string'`. True if the value is a primitive string.

### `function isSym`

Links: [source](../lang.mjs#L96); [test/example](../test/lang_test.mjs#L501).

Same as `typeof val === 'symbol'`. True if the value is a primitive symbol.

### `function isKey`

Links: [source](../lang.mjs#L102); [test/example](../test/lang_test.mjs#L508).
...
Links: [source](../lang.mjs#L107); [test/example](../test/lang_test.mjs#L528).
...
Links: [source](../lang.mjs#L112); [test/example](../test/lang_test.mjs#L548).
...
Links: [source](../lang.mjs#L117); [test/example](../test/lang_test.mjs#L569).

True for garbage values: [#nil](#function-isnil), [#NaN](#function-isnan), [#±Infinity](#function-isinf).

### `function isComp`

Links: [source](../lang.mjs#L122); [test/example](../test/lang_test.mjs#L584).
...
Links: [source](../lang.mjs#L152); [test/example](../test/lang_test.mjs#L666).

True if the input is an async generator function. False for sync functions and async non-generator functions.

### `function isObj`

Links: [source](../lang.mjs#L157); [test/example](../test/lang_test.mjs#L676).
...
Links: [source](../lang.mjs#L168); [test/example](../test/lang_test.mjs#L708).
...
Links: [source](../lang.mjs#L181); [test/example](../test/lang_test.mjs#L726).
...
Links: [source](../lang.mjs#L189); [test/example](../test/lang_test.mjs#L753).
...
Links: [source](../lang.mjs#L199); [test/example](../test/lang_test.mjs#L765).
...
Links: [source](../lang.mjs#L205); [test/example](../test/lang_test.mjs#L780).
...
Links: [source](../lang.mjs#L210); [test/example](../test/lang_test.mjs#L788).
...
Links: [source](../lang.mjs#L215); [test/example](../test/lang_test.mjs#L796).
...
Links: [source](../lang.mjs#L220); [test/example](../test/lang_test.mjs#L803).
...
Links: [source](../lang.mjs#L225); [test/example](../test/lang_test.mjs#L810).
...
Links: [source](../lang.mjs#L231); [test/example](../test/lang_test.mjs#L820).
...
Links: [source](../lang.mjs#L237); [test/example](../test/lang_test.mjs#L830).
...
Links: [source](../lang.mjs#L242); [test/example](../test/lang_test.mjs#L839).
...
Links: [source](../lang.mjs#L247); [test/example](../test/lang_test.mjs#L865).
...
Links: [source](../lang.mjs#L252); [test/example](../test/lang_test.mjs#L882).
...
Links: [source](../lang.mjs#L257); [test/example](../test/lang_test.mjs#L908).
...
Links: [source](../lang.mjs#L262); [test/example](../test/lang_test.mjs#L934).
...
Links: [source](../lang.mjs#L267); [test/example](../test/lang_test.mjs#L994).
...
Links: [source](../lang.mjs#L297); [test/example](../test/lang_test.mjs#L1024).
...
Links: [source](../lang.mjs#L303); [test/example](../test/lang_test.mjs#L1040).
...
Links: [source](../lang.mjs#L308); [test/example](../test/lang_test.mjs#L1069).
...
Links: [source](../lang.mjs#L313); [test/example](../test/lang_test.mjs#L1107).
...
Links: [source](../lang.mjs#L349); [test/example](../test/lang_test.mjs#L2079).
...
```js
import * as l from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.80/lang.mjs'
import * as ob from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.80/obs.mjs'
...
Links: [source](../lang.mjs#L373); [test/example](../test/lang_test.mjs#L1192).
...
Links: [source](../lang.mjs#L380); [test/example](../test/lang_test.mjs#L1144).
...
Links: [source](../lang.mjs#L385); [test/example](../test/lang_test.mjs#L1469).

Short for "optional". If `val` is [#non_nil](#function-issome), uses [#`req`](#function-req) to validate it. Returns `val` as-is.

### `function req`

Links: [source](../lang.mjs#L390); [test/example](../test/lang_test.mjs#L1410).
...
Links: [source](../lang.mjs#L395); [test/example](../test/lang_test.mjs#L1563).
...
Links: [source](../lang.mjs#L406); [test/example](../test/lang_test.mjs#L1524).
...
Links: [source](../lang.mjs#L408); [test/example](../test/lang_test.mjs#L1507).
...
Links: [source](../lang.mjs#L413); [test/example](../test/lang_test.mjs#L1590).
...
Links: [source](../lang.mjs#L420); [test/example](../test/lang_test.mjs#L124).
...
Links: [source](../lang.mjs#L433); [test/example](../test/lang_test.mjs#L157).
...
Links: [source](../lang.mjs#L435); [test/example](../test/lang_test.mjs#L212).
...
Links: [source](../lang.mjs#L443); [test/example](../test/lang_test.mjs#L2099).
...
Links: [source](../lang.mjs#L446); [test/example](../test/lang_test.mjs#L2130).
...
Links: [source](../lang.mjs#L463); [test/example](../test/lang_test.mjs#L256).
...
Links: [source](../lang.mjs#L464); [test/example](../test/lang_test.mjs#L242).

Same as `!!` or `Boolean`. Sometimes useful with higher-order functions.

### `function falsy`

Links: [source](../lang.mjs#L465); [test/example](../test/lang_test.mjs#L249).

Same as `!`. Sometimes useful with higher-order functions.

### `function nop`

Links: [source](../lang.mjs#L466); [test/example](../test/lang_test.mjs#L1809).

Empty function. Functional equivalent of `;` or `undefined`. Sometimes useful with higher-order functions.

### `function id`

Links: [source](../lang.mjs#L467); [test/example](../test/lang_test.mjs#L1815).

Identity function: returns its first argument unchanged. Sometimes useful with higher-order functions.

### `function val`

Links: [source](../lang.mjs#L468); [test/example](../test/lang_test.mjs#L1822).
...
Links: [source](../lang.mjs#L469); [test/example](../test/lang_test.mjs#L1836).
...
Links: [source](../lang.mjs#L472); [test/example](../test/lang_test.mjs#L2015).

Complements [#`isVac`](#function-isvac). Returns `undefined` if the input is vacuous, otherwise returns the input as-is.

### `function bind`

Links: [source](../lang.mjs#L475); [test/example](../test/lang_test.mjs#L1777).
...
Links: [source](../lang.mjs#L477); [test/example](../test/lang_test.mjs#L1799).
...
Links: [source](../lang.mjs#L483); [test/example](../test/lang_test.mjs#L1209).
...
Links: [source](../lang.mjs#L484); [test/example](../test/lang_test.mjs#L1223).
...
Links: [source](../lang.mjs#L485); [test/example](../test/lang_test.mjs#L1254).
...
Links: [source](../lang.mjs#L486); [test/example](../test/lang_test.mjs#L1290).
...
Links: [source](../lang.mjs#L495); [test/example](../test/lang_test.mjs#L1359).
...
Links: [source](../lang.mjs#L502); [test/example](../test/lang_test.mjs#L1375).
...
Links: [source](../lang.mjs#L506); [test/example](../test/lang_test.mjs#L25).
...
Links: [source](../lang.mjs#L631); [test/example](../test/lang_test.mjs#L1879).

Same as `+`.

### `function sub`

Links: [source](../lang.mjs#L632); [test/example](../test/lang_test.mjs#L1885).

Same as `-`.

### `function mul`

Links: [source](../lang.mjs#L633); [test/example](../test/lang_test.mjs#L1891).

Same as `*`.

### `function div`

Links: [source](../lang.mjs#L634); [test/example](../test/lang_test.mjs#L1897).

Same as `/`.

### `function rem`

Links: [source](../lang.mjs#L635); [test/example](../test/lang_test.mjs#L1903).

Same as `%`.

### `function lt`

Links: [source](../lang.mjs#L636); [test/example](../test/lang_test.mjs#L1911).

Same as `<`.

### `function gt`

Links: [source](../lang.mjs#L637); [test/example](../test/lang_test.mjs#L1922).

Same as `>`.

### `function lte`

Links: [source](../lang.mjs#L638); [test/example](../test/lang_test.mjs#L1933).

Same as `<=`.

### `function gte`

Links: [source](../lang.mjs#L639); [test/example](../test/lang_test.mjs#L1944).

Same as `>=`.

### `function neg`

Links: [source](../lang.mjs#L640); [test/example](../test/lang_test.mjs#L1955).

Arithmetic negation. Same as unary `-`.

### `function inc`

Links: [source](../lang.mjs#L641); [test/example](../test/lang_test.mjs#L1967).

Increments by `1`.

### `function dec`

Links: [source](../lang.mjs#L642); [test/example](../test/lang_test.mjs#L1975).

Decrements by `1`.

### `function round`

Links: [source](../lang.mjs#L645); [test/example](../test/lang_test.mjs#L1983).
...
The following APIs are exported but undocumented. Check [lang.mjs](../lang.mjs).
  ...
  * [`function resetOpt`](../lang.mjs#L451)
  * [`function swap`](../lang.mjs#L457)
  * [`function True`](../lang.mjs#L470)
  * [`function False`](../lang.mjs#L471)
  * [`function eq`](../lang.mjs#L488)
  * [`class Show`](../lang.mjs#L508)
  * [`function errType`](../lang.mjs#L669)
  * [`function msgType`](../lang.mjs#L670)
  * [`function errFun`](../lang.mjs#L672)
  * [`function msgFun`](../lang.mjs#L673)
  * [`function throwErrFun`](../lang.mjs#L674)
  * [`function errConv`](../lang.mjs#L676)
  * [`function errSynt`](../lang.mjs#L677)
  * [`function msgConv`](../lang.mjs#L678)
  * [`function errConvInst`](../lang.mjs#L680)
  * [`function msgConvInst`](../lang.mjs#L681)
  * [`function errInst`](../lang.mjs#L683)
  * [`function msgInst`](../lang.mjs#L684)
  * [`function errIn`](../lang.mjs#L686)
  * [`function msgIn`](../lang.mjs#L687)
  * [`function errImpl`](../lang.mjs#L689)
  * [`function msgImpl`](../lang.mjs#L690)
  * [`function errTrans`](../lang.mjs#L692)
  * [`function errWrap`](../lang.mjs#L700)
  * [`function errCause`](../lang.mjs#L705)
  * [`function errSkip`](../lang.mjs#L710)
  * [`const WeakRef`](../lang.mjs#L720)
  * [`const FinalizationRegistry`](../lang.mjs#L726)
  * [`function convType`](../lang.mjs#L744)
  * [`function convSynt`](../lang.mjs#L749)
  * [`function showFunName`](../lang.mjs#L755)
  * [`function get`](../lang.mjs#L770)
  * [`function getOwn`](../lang.mjs#L774)
  * [`function reqGet`](../lang.mjs#L776)
  * [`function recKeys`](../lang.mjs#L789)
