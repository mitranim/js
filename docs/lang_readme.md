...
Links: [source](../lang.mjs#L349); [test/example](../test/lang_test.mjs#L2076).
...
Links: [source](../lang.mjs#L443); [test/example](../test/lang_test.mjs#L2096).
...
Links: [source](../lang.mjs#L446); [test/example](../test/lang_test.mjs#L2127).
...
Links: [source](../lang.mjs#L466); [test/example](../test/lang_test.mjs#L1806).
...
Links: [source](../lang.mjs#L468); [test/example](../test/lang_test.mjs#L1819).
...
Links: [source](../lang.mjs#L469); [test/example](../test/lang_test.mjs#L1833).
...
Links: [source](../lang.mjs#L472); [test/example](../test/lang_test.mjs#L2012).

Complements [#`isVac`](#function-isvac). Returns `undefined` if the input is vacuous, otherwise returns the input as-is.

### `function bind`

Links: [source](../lang.mjs#L474); [test/example](../test/lang_test.mjs#L1777).
...
Links: [source](../lang.mjs#L476); [test/example](../test/lang_test.mjs#L1796).
...
Links: [source](../lang.mjs#L481); [test/example](../test/lang_test.mjs#L1209).
...
Links: [source](../lang.mjs#L482); [test/example](../test/lang_test.mjs#L1223).
...
Links: [source](../lang.mjs#L483); [test/example](../test/lang_test.mjs#L1254).
...
Links: [source](../lang.mjs#L484); [test/example](../test/lang_test.mjs#L1290).
...
Links: [source](../lang.mjs#L493); [test/example](../test/lang_test.mjs#L1359).
...
Links: [source](../lang.mjs#L499); [test/example](../test/lang_test.mjs#L1375).
...
Links: [source](../lang.mjs#L502); [test/example](../test/lang_test.mjs#L25).
...
Links: [source](../lang.mjs#L627); [test/example](../test/lang_test.mjs#L1876).

Same as `+`.

### `function sub`

Links: [source](../lang.mjs#L628); [test/example](../test/lang_test.mjs#L1882).

Same as `-`.

### `function mul`

Links: [source](../lang.mjs#L629); [test/example](../test/lang_test.mjs#L1888).

Same as `*`.

### `function div`

Links: [source](../lang.mjs#L630); [test/example](../test/lang_test.mjs#L1894).

Same as `/`.

### `function rem`

Links: [source](../lang.mjs#L631); [test/example](../test/lang_test.mjs#L1900).

Same as `%`.

### `function lt`

Links: [source](../lang.mjs#L632); [test/example](../test/lang_test.mjs#L1908).

Same as `<`.

### `function gt`

Links: [source](../lang.mjs#L633); [test/example](../test/lang_test.mjs#L1919).

Same as `>`.

### `function lte`

Links: [source](../lang.mjs#L634); [test/example](../test/lang_test.mjs#L1930).

Same as `<=`.

### `function gte`

Links: [source](../lang.mjs#L635); [test/example](../test/lang_test.mjs#L1941).

Same as `>=`.

### `function neg`

Links: [source](../lang.mjs#L636); [test/example](../test/lang_test.mjs#L1952).

Arithmetic negation. Same as unary `-`.

### `function inc`

Links: [source](../lang.mjs#L637); [test/example](../test/lang_test.mjs#L1964).

Increments by `1`.

### `function dec`

Links: [source](../lang.mjs#L638); [test/example](../test/lang_test.mjs#L1972).

Decrements by `1`.

### `function round`

Links: [source](../lang.mjs#L641); [test/example](../test/lang_test.mjs#L1980).
...
The following APIs are exported but undocumented. Check [lang.mjs](../lang.mjs).
  ...
  * [`function eq`](../lang.mjs#L486)
  * [`class Show`](../lang.mjs#L504)
  * [`function errType`](../lang.mjs#L665)
  * [`function msgType`](../lang.mjs#L666)
  * [`function errFun`](../lang.mjs#L668)
  * [`function msgFun`](../lang.mjs#L669)
  * [`function throwErrFun`](../lang.mjs#L670)
  * [`function errConv`](../lang.mjs#L672)
  * [`function errSynt`](../lang.mjs#L673)
  * [`function msgConv`](../lang.mjs#L674)
  * [`function errConvInst`](../lang.mjs#L676)
  * [`function msgConvInst`](../lang.mjs#L677)
  * [`function errInst`](../lang.mjs#L679)
  * [`function msgInst`](../lang.mjs#L680)
  * [`function errIn`](../lang.mjs#L682)
  * [`function msgIn`](../lang.mjs#L683)
  * [`function errImpl`](../lang.mjs#L685)
  * [`function msgImpl`](../lang.mjs#L686)
  * [`function errTrans`](../lang.mjs#L688)
  * [`function errWrap`](../lang.mjs#L696)
  * [`function errCause`](../lang.mjs#L701)
  * [`function errSkip`](../lang.mjs#L706)
  * [`const WeakRef`](../lang.mjs#L716)
  * [`const FinalizationRegistry`](../lang.mjs#L722)
  * [`function convType`](../lang.mjs#L740)
  * [`function convSynt`](../lang.mjs#L745)
  * [`function showFunName`](../lang.mjs#L751)
  * [`function get`](../lang.mjs#L766)
  * [`function getOwn`](../lang.mjs#L770)
  * [`function reqGet`](../lang.mjs#L772)
  * [`function recKeys`](../lang.mjs#L785)
