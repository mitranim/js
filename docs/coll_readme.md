...
```js
import * as c from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.73/coll.mjs'
```
...
Links: [source](../coll.mjs#L113); [test/example](../test/coll_test.mjs#L256).
...
Links: [source](../coll.mjs#L117); [test/example](../test/coll_test.mjs#L273).
...
Links: [source](../coll.mjs#L124); [test/example](../test/coll_test.mjs#L285).
...
Links: [source](../coll.mjs#L150); [test/example](../test/coll_test.mjs#L325).
...
Links: [source](../coll.mjs#L159); [test/example](../test/coll_test.mjs#L334).
