...
```js
import * as c from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.59/coll.mjs'
```
...
Links: [source](../coll.mjs#L221); [test/example](../test/coll_test.mjs#L475).
...
The following APIs are exported but undocumented. Check [coll.mjs](../coll.mjs).
  ...
  * [`class TypedVec`](../coll.mjs#L197)
  * [`class Que`](../coll.mjs#L229)
