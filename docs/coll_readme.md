...
```js
import * as c from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.49/coll.mjs'
```
...
Links: [source](../coll.mjs#L124); [test/example](../test/coll_test.mjs#L256).
...
Links: [source](../coll.mjs#L128); [test/example](../test/coll_test.mjs#L273).
...
Links: [source](../coll.mjs#L135); [test/example](../test/coll_test.mjs#L285).
...
Links: [source](../coll.mjs#L153); [test/example](../test/coll_test.mjs#L325).
...
Links: [source](../coll.mjs#L162); [test/example](../test/coll_test.mjs#L334).
...
Links: [source](../coll.mjs#L216); [test/example](../test/coll_test.mjs#L475).
...
The following APIs are exported but undocumented. Check [coll.mjs](../coll.mjs).
  ...
  * [`class CompatMap`](../coll.mjs#L112)
  * [`class ClsMap`](../coll.mjs#L117)
  * [`class TypedVec`](../coll.mjs#L192)
  * [`class Que`](../coll.mjs#L225)
