...
```js
import {E} from 'https://cdn.jsdelivr.net/gh/mitranim/js@0.1.16/ren_dom.mjs'
...
```js
import {A, ren} from 'https://cdn.jsdelivr.net/gh/mitranim/js@0.1.16/ren_dom.mjs'
const {e} = ren
...
```js
import {A} from 'https://cdn.jsdelivr.net/gh/mitranim/js@0.1.16/ren_dom.mjs'
import * as r from 'https://cdn.jsdelivr.net/gh/mitranim/js@0.1.16/ren_dom.mjs'
