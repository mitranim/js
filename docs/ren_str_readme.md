...
```js
import {E, ren} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.22/ren_str.mjs'
...
```js
import {A, ren} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.22/ren_str.mjs'
const {e, en} = ren
