...
```js
import * as i from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.51/iter.mjs'
```
...
Links: [source](../iter.mjs#L60); [test/example](../test/iter_test.mjs#L229).

Variant of [#`values`](#function-values) that always makes a copy. Mutating the output doesn't affect the original.

### `function entries`

Links: [source](../iter.mjs#L84); [test/example](../test/iter_test.mjs#L271).
...
Links: [source](../iter.mjs#L111); [test/example](../test/iter_test.mjs#L291).
...
Links: [source](../iter.mjs#L115); [test/example](../test/iter_test.mjs#L316).
...
Links: [source](../iter.mjs#L125); [test/example](../test/iter_test.mjs#L337).
...
Links: [source](../iter.mjs#L135); [test/example](../test/iter_test.mjs#L360).
...
Links: [source](../iter.mjs#L139); [test/example](../test/iter_test.mjs#L379).
...
Links: [source](../iter.mjs#L141); [test/example](../test/iter_test.mjs#L394).
...
Links: [source](../iter.mjs#L143); [test/example](../test/iter_test.mjs#L410).
...
Links: [source](../iter.mjs#L148); [test/example](../test/iter_test.mjs#L472).
...
Links: [source](../iter.mjs#L173); [test/example](../test/iter_test.mjs#L476).

Shortcut for [#`len`](#function-len) > 0.

### `function each`

Links: [source](../iter.mjs#L183); [test/example](../test/iter_test.mjs#L518).
...
Links: [source](../iter.mjs#L188); [test/example](../test/iter_test.mjs#L539).
...
Links: [source](../iter.mjs#L190); [test/example](../test/iter_test.mjs#L572).
...
Links: [source](../iter.mjs#L199); [test/example](../test/iter_test.mjs#L583).
...
```js
import * as i from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.51/iter.mjs'
import * as o from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.51/obj.mjs'
...
Links: [source](../iter.mjs#L204); [test/example](../test/iter_test.mjs#L621).

Equivalent to `i.compact(i.map(val, fun))`. See [#`map`](#function-map) and [#`compact`](#function-compact).

### `function mapFlat`

Links: [source](../iter.mjs#L206); [test/example](../test/iter_test.mjs#L634).
...
Links: [source](../iter.mjs#L215); [test/example](../test/iter_test.mjs#L664).

Opposite of [#`filter`](#function-filter). Equivalent to `i.filter(val, l.not(fun))`.

### `function compact`

Links: [source](../iter.mjs#L217); [test/example](../test/iter_test.mjs#L680).
...
Links: [source](../iter.mjs#L223); [test/example](../test/iter_test.mjs#L692).
...
Links: [source](../iter.mjs#L233); [test/example](../test/iter_test.mjs#L727).
...
Links: [source](../iter.mjs#L244); [test/example](../test/iter_test.mjs#L756).
...
Links: [source](../iter.mjs#L250); [test/example](../test/iter_test.mjs#L771).
...
Links: [source](../iter.mjs#L256); [test/example](../test/iter_test.mjs#L788).
...
Links: [source](../iter.mjs#L322); [test/example](../test/iter_test.mjs#L928).
...
Links: [source](../iter.mjs#L333); [test/example](../test/iter_test.mjs#L938).
...
Links: [source](../iter.mjs#L341); [test/example](../test/iter_test.mjs#L950).
