...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/prax.mjs'
...
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/prax.mjs'
import * as dr from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/dom_reg.mjs'
...
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/dom_glob_shim.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/dom_glob_native.mjs'
...
The following APIs are exported but undocumented. Check [prax.mjs](../prax.mjs).
  ...
  * [`function renderDocument`](../prax.mjs#L560)
  * [`function isSeq`](../prax.mjs#L569)
  * [`function isRaw`](../prax.mjs#L573)
  * [`function reqRaw`](../prax.mjs#L574)
  * [`function isNode`](../prax.mjs#L577)
  * [`function reqNode`](../prax.mjs#L578)
  * [`function isElement`](../prax.mjs#L581)
  * [`function reqElement`](../prax.mjs#L582)
  * [`function isDocument`](../prax.mjs#L584)
  * [`function optDocument`](../prax.mjs#L592)
  * [`function reqDocument`](../prax.mjs#L593)
  * [`function isNamespaced`](../prax.mjs#L595)
  * [`function deref`](../prax.mjs#L598)
