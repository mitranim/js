...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/prax.mjs'
...
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/prax.mjs'
import * as dr from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/dom_reg.mjs'
...
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/dom_glob_shim.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.36/dom_glob_native.mjs'
...
The following APIs are exported but undocumented. Check [prax.mjs](../prax.mjs).
  ...
  * [`class Raw`](../prax.mjs#L347)
  * [`class RenPh`](../prax.mjs#L351)
  * [`class RenHtmlPh`](../prax.mjs#L355)
  * [`class RenSvgPh`](../prax.mjs#L359)
  * [`class MixRenCache`](../prax.mjs#L363)
  * [`function MixChild`](../prax.mjs#L398)
  * [`class MixChildCache`](../prax.mjs#L400)
  * [`class PropBui`](../prax.mjs#L460)
  * [`function renderDocument`](../prax.mjs#L565)
  * [`function isSeq`](../prax.mjs#L574)
  * [`function isRaw`](../prax.mjs#L578)
  * [`function reqRaw`](../prax.mjs#L579)
  * [`function isNode`](../prax.mjs#L582)
  * [`function reqNode`](../prax.mjs#L583)
  * [`function isElement`](../prax.mjs#L586)
  * [`function reqElement`](../prax.mjs#L587)
  * [`function isDocument`](../prax.mjs#L589)
  * [`function optDocument`](../prax.mjs#L597)
  * [`function reqDocument`](../prax.mjs#L598)
  * [`function isNamespaced`](../prax.mjs#L600)
  * [`function deref`](../prax.mjs#L603)
