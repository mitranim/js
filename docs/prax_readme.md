...
```js
import {Ren, A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/prax.mjs'
...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/prax.mjs'

// Choose the right one.
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/dom_glob_shim.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/dom_glob_native.mjs'
...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/prax.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.26/dom_glob_shim.mjs'
