...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/prax.mjs'
...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/prax.mjs'
import * as dr from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/dom_reg.mjs'
...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/prax.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/dom_global_shim.mjs'
...
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/dom_global_shim.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.60/dom_global_native.mjs'
