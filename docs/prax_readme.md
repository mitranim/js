...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/prax.mjs'
import {A} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/prax.mjs'
...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/prax.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/dom_global_shim.mjs'
...
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/dom_global_shim.mjs'
import * as dg from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.65/dom_global_native.mjs'
