...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.73/path.mjs'
...
```js
import {paths as p} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.73/io_deno.mjs'
