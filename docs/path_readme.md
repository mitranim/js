...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.71/path.mjs'
...
```js
import {paths as p} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.71/io_deno.mjs'
