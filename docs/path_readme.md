...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/path.mjs'
...
```js
import {paths as p} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.45/io_deno.mjs'
