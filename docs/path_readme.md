...
```js
import * as p from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.29/path.mjs'
...
```js
import {paths as p} from 'https://cdn.jsdelivr.net/npm/@mitranim/js@0.1.29/io_deno.mjs'
