...
/*
Ported from https://github.com/mitranim/prax.

Defined as a function because it should also be used for testing `ren_dom.mjs`.
DOM tests haven't been ported yet.
*/
function testCommon(r, eqm) {
  const {E} = r
  function F(...val) {return r.ren.frag(...val)}

  t.throws(() => E(`link`, {}, null), Error, `expected void element "link" to have no children, got [null]`)
