...
t.bench(function bench_concat_array_ours() {l.reqArr(i.concat(itc.numArr, itc.dictArr))})
t.bench(function bench_concat_array_native() {l.reqArr(itc.numArr.concat(itc.dictArr))})
t.bench(function bench_concat_array_lodash() {l.reqArr(lo.concat(itc.numArr, itc.dictArr))})
...
t.bench(function bench_array_from_simple_ours() {l.reqArr(i.slice(itc.numArr))})
// t.bench(function bench_array_from_simple_ours() {l.reqArr(i.arrCopy(itc.numArr))})
...
t.bench(function bench_each_array_forEach() {itc.numArr.forEach(l.nop)})
